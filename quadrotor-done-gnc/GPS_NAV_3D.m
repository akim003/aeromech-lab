...
% Mean standard deviation of the pseudo ranges (σ_p)
...
for i=1:length(Data.pseudo_range)
    ...
    while stop == 0
	    ...
	    b = [rho1 - rho1_bar; rho2 - rho2_bar; rho3 - rho3_bar; rho4 - rho4_bar; rho5 - rho5_bar; rho6 - rho6_bar];
